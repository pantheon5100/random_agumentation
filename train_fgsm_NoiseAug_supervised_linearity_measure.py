...
def get_args():
    ...
    parser.add_argument('--n_holes', type=int)
...
def main():
    ...
    train_loader, test_loader, val_loader = get_loaders(args.data_dir, args.batch_size, args.image_normalize, cifar10_mean, cifar10_std, args.cutout, args.n_holes, args.length)
