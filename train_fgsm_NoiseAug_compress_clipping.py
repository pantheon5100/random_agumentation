...
def get_args():
    ...
    parser.add_argument('--clamp_compress_factor', default=1., type=float)
...
def main():
    ...
    args.out_dir = args.out_dir + f"-clamp_compress_factor_{args.clamp_compress_factor}-"


    args.clamp_compress_factor = args.clamp_compress_factor / args.epsilon
    ...
    for epoch in range(args.epochs):
        ...
        for i, (X, y) in enumerate(train_loader):
            ...
            delta.data = clamp(delta + alpha * torch.sign(grad), -args.clamp_compress_factor*epsilon, args.clamp_compress_factor*epsilon)
